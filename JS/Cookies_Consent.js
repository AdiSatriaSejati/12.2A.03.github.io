    ...
    (e.Popup = (function () {
      var n = {
        ...
        content: {
          ...
          message: "Beberapa cookie ini sangat penting, sementara yang lain membantu kami meningkatkan pengalaman Anda di situs web kami. Cari tahu lebih lanjut:",
          dismiss: "Got it!",
          allow: "Allow cookies",
          deny: "Decline",
        ...
        (o.prototype.initialise = function (i) {
          ...
          (function () {
              ...
              if (a) {
                var l = function (o) {
                  for (
                    var s = !1, r = o.path.length, a = c.length, u = 0; u < r; u++
                  )
                    if (!s)
                      for (var h = 0; h < a; h++)
